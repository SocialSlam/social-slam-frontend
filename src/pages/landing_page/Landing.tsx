		...
		<div className="column landing_page">
			...
			<footer className="row">
				...
				<div className="social_media">
					...
					<a href="https://www.facebook.com/SocialSlam.official/" target="_blank" rel="noreferrer">
						<img src="icons/facebook.svg"/>
					</a>
					<a href="https://www.instagram.com/socialslam_official/" target="_blank" rel="noreferrer">
