      ...
      e.exports = function (e) {
        ...
        return (
          (t = setInterval(function () {
            d.send({ method: '__ready__', params: h })
          }, 50)),
          d.listen('__ready__', function (e) {
            if (e === h) {
              clearInterval(t), (l = !0)
              for (var n = 0; n < a.length; n++) d.send(a[n])
              a = []
            } else d.send({ method: '__ready__', params: e })
          }),
          d
        )
      }
    ...
    function (e, t, n) {
      ...
      function u(e) {
        ...
        if (!n.host) {
          ...
          if (t) {
            const { host: e, hostname: r, pathname: s, port: a } = c(
              o('org.jitsi.meet://' + t)
            )
        ...
        sendRequest(e) {
          ...
          return new Promise((n, i) => {
            this._responseHandlers.set(t, ({ error: e, result: t }) => {
              void 0 !== t
                ? n(t)
                : i(void 0 !== e ? e : new Error('Unexpected response format!'))
            }),
      ...
      const m = s(window.location).jitsi_meet_external_api_id,
        y = {}
      let _
      'number' == typeof m && (y.scope = 'jitsi_meet_external_api_' + m),
